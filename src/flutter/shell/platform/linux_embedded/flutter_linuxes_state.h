...
#ifndef FLUTTER_SHELL_PLATFORM_LINUX_EMBEDDED_FLUTTER_LINUXES_STATE_H_
#define FLUTTER_SHELL_PLATFORM_LINUX_EMBEDDED_FLUTTER_LINUXES_STATE_H_
...
namespace flutter {
struct FlutterLinuxesEngine;
struct FlutterLinuxesView;
}  // namespace flutter
...
struct FlutterDesktopViewControllerState {
  ...
  std::unique_ptr<flutter::FlutterLinuxesView> view;
};
...
struct FlutterDesktopPluginRegistrar {
  ...
  flutter::FlutterLinuxesEngine* engine = nullptr;
};
...
#endif  // FLUTTER_SHELL_PLATFORM_LINUX_EMBEDDED_FLUTTER_LINUXES_STATE_H_