...
#ifndef FLUTTER_SHELL_PLATFORM_LINUX_EMBEDDED_SYSTEM_UTILS_H_
#define FLUTTER_SHELL_PLATFORM_LINUX_EMBEDDED_SYSTEM_UTILS_H_
...
#endif  // FLUTTER_SHELL_PLATFORM_LINUX_EMBEDDED_SYSTEM_UTILS_H_
