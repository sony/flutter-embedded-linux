...
#ifndef FLUTTER_SHELL_PLATFORM_LINUX_EMBEDDED_WINDOW_LINUXES_WINDOW_EGLSTREAM_H_
#define FLUTTER_SHELL_PLATFORM_LINUX_EMBEDDED_WINDOW_LINUXES_WINDOW_EGLSTREAM_H_
...
class LinuxesWindowEglstream : public LinuxesWindow,
                               public WindowBindingHandler {
 public:
  LinuxesWindowEglstream(FlutterWindowMode window_mode, int32_t width,
                         int32_t height, bool show_cursor);
  ~LinuxesWindowEglstream();
 ...
 private:
  ...
  std::unique_ptr<NativeWindowEglstream> native_window_;
  std::unique_ptr<SurfaceGlEglstream> render_surface_;
...
#endif  // FLUTTER_SHELL_PLATFORM_LINUX_EMBEDDED_WINDOW_LINUXES_WINDOW_EGLSTREAM_H_